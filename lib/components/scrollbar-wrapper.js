...
var ScrollbarWrapper = React.createClass({
  ...
  handleWindowScroll: function handleWindowScroll(event) {
  ...
  render: function render() {
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          'div',
          { className: 'ScrollbarChildren', style: { position: 'relative', paddingBottom: this.state.nativeScrollbarWidth } },
          this.props.children,
  ...
  isPartiallyVisible: function isPartiallyVisible() {
