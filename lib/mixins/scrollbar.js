...
var ScrollbarMixin = {
  ...
  getStickLength: function getStickLength() {
    if (!this.refs.scrollableContent) {
      return {};
    }
  ...
  getScrollbarLength: function getScrollbarLength() {
  ...
  calculateStickPosition: function calculateStickPosition(left, top) {
  ...
  scrollbarRequired: function scrollbarRequired() {
    if (!this.refs.scrollableContent) {
      return {};
    }
  ...
  handleMouseDown: function handleMouseDown(axis, event) {
  ...
  handleStickDrag: function handleStickDrag(event) {
    ...
    if (this.state.initialMovement) {
      initialScrollPosition = origin === 'left' ? ReactDOM.findDOMNode(this.refs.scrollableContent).scrollLeft : ReactDOM.findDOMNode(this.refs.scrollableContent).scrollTop;
    ...
    if (this.state.axis === 'x') {
      ReactDOM.findDOMNode(this.refs.scrollableContent).scrollLeft = initialScrollPosition + scaledMovement.x;
    } else {
      ReactDOM.findDOMNode(this.refs.scrollableContent).scrollTop = initialScrollPosition + scaledMovement.y;
    }
  },
  ...
  getScrollbarProps: function getScrollbarProps() {
  ...
  scrollbarContainerStyle: function scrollbarContainerStyle() {
    return {
      position: 'relative',
      overflow: 'hidden'
    };
  ...
  scrollbarContentStyle: function scrollbarContentStyle() {
    var style = {};
